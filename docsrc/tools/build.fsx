...
//  fileInfo.CopyTo(Path.Combine(relative "../../../../docs/content", fileInfo.Name)) |> ignore
...
/// Processes a single Markdown document and produce HTML output
let processTufteAsHtml () =
  let file = relative "../content/tufte.md"
  let output = relative "../../docs/tufte.html"
  let template = relative "templates/tufte.cshtml"
  RazorLiterate.ProcessMarkdown(file, template, output)
